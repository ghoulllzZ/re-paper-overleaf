...
\footnotesize
\textit{Note.} All treatments are evaluated on the same requirement documents and share the same initial round-0 LLM outputs whenever applicable. This paired design controls for stochastic variation in LLM generation and isolates the effects of equal aggregation, roundtable discussion, and reliability-aware fixed weighting.
\end{minipage}
\end{table}
