...
\begin{tabularx}{\textwidth}{p{1.9cm} p{1.0cm} p{1.0cm} p{1.0cm} p{0.9cm} X p{1.5cm}}
\toprule
\textbf{Treatment} & \textbf{Macro-P} & \textbf{Macro-R} & \textbf{Macro-F1} & \textbf{Avg. issues} & \textbf{Primary characteristic} & \textbf{Role} \\
\midrule
